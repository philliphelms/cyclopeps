...
for ind in range(len(D)):
    ...
    # Current
    try:
        currents = peps.calc_op(curr_ops,return_sum=False,ket=pepsl,chi=chi[ind])
        ...
        for i in range(Ny):
            ...
            print(print_str)
        # Calculate Density
        density_top = peps.calc_op(dens_ops_top,return_sum=False,ket=pepsl,chi=chi[ind])
        density_bot = peps.calc_op(dens_ops_bot,return_sum=False,ket=pepsl,chi=chi[ind])
