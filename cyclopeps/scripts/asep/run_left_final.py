...
prepend=argv[6]
fnamel = prepend+"Nx{}_Ny{}_sx{}_sy{}_run_left".format(Nx,Ny,sxind,syind)
...
for ind in range(len(D)):
    ...
    pepsl.D = D[ind]
    pepsl.chi = chi[ind]
    pepsl.fname = prepend+"Nx{}_Ny{}_sx{}_sy{}_D{}_chi{}_run_left".format(Nx,Ny,sxind,syind,D[ind],chi[ind])
